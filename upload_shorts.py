...
API_KEY = 'AIzaSyAd-MkreO0212CQ1pI3dvMd5raVb3-zRgA'
CLIENT_SECRET_FILE = 'client_secret.json'
SCOPES = ['https://www.googleapis.com/auth/youtube.upload']

# Folder path containing titles and descriptions
titles_folder = 'C:/x/titles_folder'  # Update the path to the correct titles folder
output_folder = 'C:/x/output_folder'  # Update the path to the correct output folder
